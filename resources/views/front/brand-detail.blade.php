    ...
    <section class="category container d-flex justify-content-between gap-4" id="category">
        <form action="" class="category-filter d-md-block d-none" id="category-filter">
            ...
            <div class="category-filter_nav">
                <div class="d-flex justify-content-between mb-3 mt-4">
                    <h6 class="category-filter_title">Страна бренда</h6>
                ...
                <ul class="category-filter_list" name="brandList">
                    <li>
                        ...
                        <label for="brandCountry1">Россия</label>
                    </li>
                    <li>
                        <input type="checkbox" name="brandCountry" id="brandCountry2" value="brandCountry2">
                        <label for="brandCountry2">США</label>
                    </li>
                    <li>
                        <input type="checkbox" name="brandCountry" id="brandCountry3" value="brandCountry3">
                        <label for="brandCountry3">Китай</label>
                    </li>
                    <li>
                        <input type="checkbox" name="brandCountry" id="brandCountry4" value="brandCountry4">
                        <label for="brandCountry4">Германия</label>
                    </li>
                </ul>
            ...
            <div class="category-goods">
                ...
                <div class="goods_item">
                    ...
                    <div style="padding: 10px;">
                        ...
                        <a href="{{ route('brand.detail', $brand->slug) }}" class="goods_companyName" name="actualGoodsCompanyName">{{ $brand->title }}</a>
