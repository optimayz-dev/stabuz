...
<footer class="footer d-md-block d-none">
    <div class="d-flex flex-wrap justify-content-between gap-md-2 gap-4">
        ...
        <div class="footer-delivery d-flex flex-column col-lg-3 col-md-3 col-sm-5 col-12 gap-2">
            ...
            <a href="/" style="margin-top: 30px;color: var(--red);font-size: 20px;line-height: 140%;font-weight: 600;">Скидки</a>
        ...
        <div class="footer-sellers d-flex flex-column col-lg-2 col-md-3 col-sm-6 col-12 gap-2">
            <h6>Покупателям</h6>
            <a href="/">Гарантия качества</a>
            <a href="/">Как купить?</a>
            <a href="/" style="margin: 20px 0;font-size: 20px;line-height: 140%;color: var(--black);font-weight: 600;">Тендеры</a>
    ...
    <div class="footer-agreement d-flex gap-2 flex-wrap">
        <p>© 2018 — 2023</p>
        <p>Stab.uz</p>
...
<section class="footer-menu d-md-none d-flex justify-content-sm-center justify-content-between align-items-center gap-sm-5 gap-0">
    ...
    <a href="basket.html" class="footer-menu_item active">
