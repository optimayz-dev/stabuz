...
<div class="success" id="success_div">Товар добавлен в корзину <img src="{{ asset('assets/front/images/icons/arrTop.png') }}" alt=""></div>
<!-- Модальное окно -->
...
{{--                            </li>--}}
            ...
            <div class="header-menu d-md-flex d-none justify-content-center gap-md-3 gap-2">
                ...
                <a href="{{ route('basket') }}" class="basket-btn_nav active">
                    ...
                    <p>Корзина</p>
                    <div class="menu-count total_quantity1"> @if(!empty(session('cart'))){{ count(session('cart')) }}@endif</div>
                </a>
            </div>
        </div>
    </div>
