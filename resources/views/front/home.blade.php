    ...
    <div class="actual-goods_slider owl-carousel" name="actualGoodsSlider">
        <div class="goods_item">
            ...
            <div style="padding: 15px;">
                ...
                <a href="productCard.html" class="goods_name" name="actualGoodsName">Швейная машина Comfortstitch 11 машина Швейная Швейная</a>
        ...
        <div class="goods_item">
            ...
            <div style="padding: 15px;">
                <p class="goods_currentPrice" name="actualGoodsCurrentPrice">477 500 сум</p>
