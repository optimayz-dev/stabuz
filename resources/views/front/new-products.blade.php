        ...
        <form action="" class="category-filter d-md-block d-none" id="category-filter">
            <div class="category-categories d-flex flex-column">
                ...
                <ul class="category-categories_list" name="newGoodsList">
                    <li><a href="/" class="category-categories-link">Дом и сад <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
                    <li><a href="/" class="category-categories-link">Освещение <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
                    <li><a href="/" class="category-categories-link">Станки <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
                    <li><a href="/" class="category-categories-link">Инструменты <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
                    <li><a href="/" class="category-categories-link">Дом и сад <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
                    <li><a href="/" class="category-categories-link">Освещение <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
                    <li><a href="/" class="category-categories-link">Станки <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
                    <li><a href="/" class="category-categories-link">Инструменты <span class="newGoodsCount">+ <i name="newGoodsCount">20</i></span></a></li>
            ...
            <div class="category-filter_nav">
                ...
                <ul class="category-filter_list" name="categoryCountryList">
                    <li> <input type="checkbox" name="country" id="country1" value="country1"> <label for="country1">Страна 1</label> </li> <li> <input type="checkbox" name="country" id="country2" value="country2"> <label for="country2">Страна 2</label> </li> <li> <input type="checkbox" name="country" id="country3" value="country3"> <label for="country3">Страна 3</label> </li> <li> <input type="checkbox" name="country" id="country4" value="country4"> <label for="country4">Страна 4</label> </li> <li> <input type="checkbox" name="country" id="country5" value="country5"> <label for="country5">Страна 5</label> </li> <li> <input type="checkbox" name="country" id="country6" value="country6"> <label for="country6">Страна 6</label> </li> <li> <input type="checkbox" name="country" id="country7" value="country7"> <label for="country7">Страна 7</label> </li> <li> <input type="checkbox" name="country" id="country8" value="country8"> <label for="country8">Страна 8</label> </li> <li> <input type="checkbox" name="country" id="country9" value="country9"> <label for="country9">Страна 9</label> </li> <li> <input type="checkbox" name="country" id="country10" value="country10"> <label for="country10">Страна 10</label> </li> <li> <input type="checkbox" name="country" id="country11" value="country11"> <label for="country11">Страна 11</label> </li> <li> <input type="checkbox" name="country" id="country12" value="country12"> <label for="country12">Страна 12</label> </li> <li> <input type="checkbox" name="country" id="country13" value="country13"> <label for="country13">Страна 13</label> </li> <li> <input type="checkbox" name="country" id="country14" value="country14"> <label for="country14">Страна 14</label> </li> <li> <input type="checkbox" name="country" id="country15" value="country15"> <label for="country15">Страна 15</label> </li> <li> <input type="checkbox" name="country" id="country16" value="country16"> <label for="country16">Страна 16</label> </li> <li> <input type="checkbox" name="country" id="country17" value="country17"> <label for="country17">Страна 17</label> </li> <li> <input type="checkbox" name="country" id="country18" value="country18"> <label for="country18">Страна 18</label> </li> <li> <input type="checkbox" name="country" id="country19" value="country19"> <label for="country19">Страна 19</label> </li> <li> <input type="checkbox" name="country" id="country20" value="country20"> <label for="country20">Страна 20</label> </li> <li> <input type="checkbox" name="country" id="country21" value="country21"> <label for="country21">Страна 21</label> </li> <li> <input type="checkbox" name="country" id="country22" value="country22"> <label for="country22">Страна 22</label> </li> <li> <input type="checkbox" name="country" id="country23" value="country23"> <label for="country23">Страна 23</label> </li> <li> <input type="checkbox" name="country" id="country24" value="country24"> <label for="country24">Страна 24</label> </li> <li> <input type="checkbox" name="country" id="country25" value="country25"> <label for="country25">Страна 25</label> </li>
                </ul>
