...
{{--                </div>--}}
        ...
        <div class="product-content d-flex flex-column align-items-end">
            <h6 class="title mb-4 mt-4 p-0 container d-lg-none d-flex goods_name" name="productName">{{ $product->title }}</h6>
            ...
            <div class="product-content_purchase d-flex flex-wrap justify-content-between">
                <div class="product-content_purchase--info d-lg-none  d-flex justify-content-between gap-2">
                    ...
                    <button type="button" class="product-content_func--btns">
                        <svg width="25" height="22" viewBox="0 0 29 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 8.89256C5 6.71638 6.73126 5 8.80838 5C9.80909 5 10.7747 5.40303 11.4912 6.12989L13.0756 7.73734C13.4515 8.11865 13.9646 8.33333 14.5 8.33333C15.0354 8.33333 15.5485 8.11865 15.9244 7.73734L17.5088 6.12989C18.2253 5.40303 19.1909 5 20.1916 5C22.2687 5 24 6.71638 24 8.89256C24 9.93411 23.5919 10.9273 22.8744 11.6552L14.5 20.151L6.12558 11.6552C5.40811 10.9273 5 9.93411 5 8.89256ZM8.80838 1C4.4683 1 1 4.56145 1 8.89256C1 10.9766 1.81576 12.9809 3.27688 14.4632L13.0756 24.404C13.4515 24.7853 13.9646 25 14.5 25C15.0354 25 15.5485 24.7853 15.9244 24.404L25.7231 14.4632C27.1842 12.9809 28 10.9766 28 8.89256C28 4.56145 24.5317 1 20.1916 1C18.1113 1 16.1222 1.83864 14.6601 3.32189L14.5 3.48434L14.3399 3.32189C12.8778 1.83865 10.8887 1 8.80838 1Z"  stroke="white" stroke-width="2"/>
                        </svg>
                    </button>
                </div>
                <div class="product-add_btns d-flex align-items-center justify-content-between">
                    <button class="goods-addProduct-minus disabled" type="button"><svg width="30" height="30" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button" class="product-buy_btn goods-item_addToBasket">В корзину <svg width="44" height="44" viewBox="0 0 67 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-flex align-items-center gap-3">
                    <button type="button" class="product-content_func--btns">
                        <svg width="19" height="20" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16 6C16 5.44772 16.4477 5 17 5C17.5523 5 18 5.44772 18 6C18 6.55228 17.5523 7 17 7C16.4477 7 16 6.55228 16 6ZM17 1C14.2386 1 12 3.23858 12 6C12 6.13297 12.0052 6.26486 12.0155 6.39547L9.08166 8.06241C8.23291 7.39748 7.1624 7 6 7C3.23858 7 1 9.23858 1 12C1 14.7614 3.23858 17 6 17C7.17104 17 8.24876 16.5966 9.10048 15.9228L12.0168 17.5883C12.0057 17.7242 12 17.8615 12 18C12 20.7614 14.2386 23 17 23C19.7614 23 22 20.7614 22 18C22 15.2386 19.7614 13 17 13C15.8357 13 14.7637 13.3988 13.9143 14.0656L10.9848 12.3925C10.9949 12.2629 11 12.132 11 12C11 11.8597 10.9942 11.7205 10.9828 11.5828L13.9016 9.92439C14.753 10.5973 15.8299 11 17 11C19.7614 11 22 8.76142 22 6C22 3.23858 19.7614 1 17 1ZM5 12C5 11.4477 5.44772 11 6 11C6.55228 11 7 11.4477 7 12C7 12.5523 6.55228 13 6 13C5.44772 13 5 12.5523 5 12ZM16 18C16 17.4477 16.4477 17 17 17C17.5523 17 18 17.4477 18 18C18 18.5523 17.5523 19 17 19C16.4477 19 16 18.5523 16 18Z"  stroke="white" stroke-width="2"/>
                        </svg>
                    </button>
            ...
            <div class="product-content_info mt-4 d-sm-flex d-block flex-lg-column flex-sm-row flex-column justify-content-between">
                <table>
                    <tbody>
                    <tr>
                        <td>Артикул</td>
    ...
    <section class="container tab-content mt-5 product-decr_tabs">
        <div class="product-tabs nav d-md-flex d-none align-items-center">
            ...
            <button type="button" class="product-add_review--btn d-none" id="productAdRreviewBtn" data-bs-toggle="modal" data-bs-target="#addReviewProductModal">Написать отзыв</button>
        </div>
...
{{--                        </table>--}}
            ...
            <div class="tab-pane fade" id="productReviews">
                <div class="d-md-none d-flex justify-content-between align-items-center mb-4 mt-5">
                    ...
                    <button type="button" id="productAdRreviewBtn" data-bs-toggle="modal" data-bs-target="#addReviewProductModal">Написать отзыв</button>
                </div>
