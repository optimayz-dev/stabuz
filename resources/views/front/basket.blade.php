...
@section('content')
    ...
    <section class="basket container">
        ...
        <form action="orderNatural.html" class="basket-form d-flex justify-content-between gap-4">
            <div class="w-100">
                ...
                <div id="basket-products">
                    ...
                    <!-- <div class="basket-product d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="basket-product_name">Швейная машина CHAYKA 590</p>
                        </div>
                        <div class="basket-product_functs d-flex justify-content-between align-items-start gap-4">
                            <div class="basket-product_btns">
                                <button class="basket-product_minus disabled" type="button"><svg width="30" height="30" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <input value="1" type="text" class="item_count" disabled></input>
                                <button class="basket-product_plus"  type="button"><svg width="30" height="30" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <h6 class="basket-product_currentPrice">1 529 500 сум</h6>
                                <p class="goods_oldPrice basket-product_oldPrice" name="actualGoodsOldPrice">17 020 000 сум</p>
            ...
            <div>
                <div class="basket-order">
                    ...
                    <div class="basket-order_delivery--text mb-4" id="basketOrderDeliveryTextFalse">
                        ...
                        <p>Бесплатная доставка при заказе свыше <i id="deliverySumm">500 000</i> сум после полной оплаты товара<br>Осталось <i id="leftDelivery"></i> сум</p>
                    </div>
                ...
                <div class="basket-register">
                    <p><a href="sign-in.html">Авторизуйтесь</a>,
                        если совершали покупки на Stab.uz</p>
                    <p><a href="sign-up.html">Зарегистрируйтесь</a>,
        ...
        <a href="/" class="d-flex gap-2 mt-lg-5 mt-3 basket-back_btn">
            <img src="image/icons/greenArrLeft.png" alt="">
            Продолжить покупки
        </a>
    </section>
    <!-- empty basket -->
    <section class="empty-basket_cont container">
        ...
        <div class="empty-basket">
            ...
            <div class="col-sm-6 col-11">
                <img src="/image/shopping cart 2 1.png" alt="">
            </div>
        </div>
    </section>
@endsection
