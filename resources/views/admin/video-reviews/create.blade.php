                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    @endif
                                    <form action="{{ route('admin.video-review.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <th>Seo описание</th>
                                                <th>Meta keywords</th>
                                                <th>Ссылка на видеообзор (youtube)</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        @enderror
                                                        <label>
                                                            <input type="text" value="" name="title" class="updateSelected" placeholder="Название">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            <input type="text" value="" name="seo_title" class="updateSelected" placeholder="Seo название">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        @error('description')
                                                        ...
                                                        @enderror
                                                        <label>
                                                            <textarea name="description" class="updateSelected" placeholder="Описание"></textarea>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
