                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    @endif
                                    <form action="{{ route('admin.video-review.update', $video->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('patch')
                                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $video->title ?? '' }}" name="title" class="updateSelected" placeholder="Название" required>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input type="text" value="{{ $video->seo_title ?? '' }}" name="seo_title" class="updateSelected" placeholder="Seo название">
                                                    </label>
                                                </td>
                                                <td>
                                                    @error('description')
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <textarea name="description" class="updateSelected" placeholder="Описание">{{ $video->description ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <textarea name="seo_description" class="updateSelected" placeholder="Seo Описание">{{ $video->seo_description ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <textarea type="text" name="meta_keywords" placeholder="Мета ключи" class="updateSelected">{{ $video->meta_keywords ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    @error('link')
                                                    ...
                                                    @enderror
                                                    <label for="">
{{--                                                        <img src="{{ asset($video->link ?? '') }}" alt="" style="width: 70px">--}}
                                                        <input type="text" name="link" placeholder="" value="{{ $video->link }}" required>
                                                    </label>
                                                </td>
                                            </tr>
                                            </tbody>
