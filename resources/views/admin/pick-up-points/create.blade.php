                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    @endif
                                    <form action="{{ route('admin.pick-up-point.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        @enderror
                                                        <label>
                                                            <input type="text" value="" name="city" class="updateSelected" placeholder="Город">
                                                        </label>
                                                    </td>
                                                    @error('address')
                                                        <code>{{ $message }}</code>
                                                    ...
                                                    <td>
                                                        <label>
                                                            <input type="text" value="" name="address" class="updateSelected" placeholder="Адрес (название улицы и т.п)">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        @error('link')
                                                        ...
                                                        @enderror
                                                        <label>
                                                            <input type="text" value="" name="link" class="updateSelected" placeholder="Ссылка на адрес с карты">
                                                        </label>
                                                    </td>
