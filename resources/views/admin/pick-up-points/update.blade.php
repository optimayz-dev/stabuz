    ...
    <div class="right_col" role="main">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>Пункты Самовывоза</small></h2>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    @endif
{{--                                    @dd($point->id)--}}
                                    <form action="{{ route('admin.pick-up-point.update', $point->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $point->city ?? '' }}" name="city" class="updateSelected" placeholder="Город">
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $point->address ?? '' }}" name="address" class="updateSelected" placeholder="Адрес (название улицы и т.п)">
                                                    </label>
                                                </td>
                                                <td>
                                                    @error('link')
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $point->link ?? '' }}" name="link" class="updateSelected" placeholder="Ссылка на адрес с карты">
                                                    </label>
                                                </td>
