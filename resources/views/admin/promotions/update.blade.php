                                        ...
                                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $promotion->title ?? '' }}" name="title" class="updateSelected" placeholder="Название">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input type="text" value="{{ $promotion->seo_title ?? '' }}" name="seo_title" class="updateSelected" placeholder="Seo название">
                                                    </label>
                                                </td>
                                                <td>
                                                    @error('description')
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <textarea name="description" class="updateSelected" placeholder="Описание">{{ $promotion->description ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <textarea name="seo_description" class="updateSelected" placeholder="Seo Описание">{{ $promotion->seo_description ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <textarea type="text" name="meta_keywords" placeholder="Мета ключи" class="updateSelected">{{ $promotion->meta_keywords ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    @error('image')
                                                    ...
                                                    @enderror
                                                    <label for="">
                                                        <img src="{{ asset($promotion->image ?? '') }}" alt="" style="width: 70px">
