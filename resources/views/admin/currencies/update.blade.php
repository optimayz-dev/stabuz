                                        ...
                                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $currency->type ?? '' }}" name="type" class="updateSelected" placeholder="Тип валюта">
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $currency->value ?? '' }}" name="value" class="updateSelected" placeholder="Курс">
                                                    </label>
                                                </td>
