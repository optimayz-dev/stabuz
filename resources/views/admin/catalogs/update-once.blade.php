    ...
    <div class="right_col" role="main">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>Изменение каталога</small></h2>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    @endif
                                    <div class="container">
                                        <form action="{{ route('admin.catalog.update', $catalog->id) }}" method="POST" class="categories" enctype="multipart/form-data">
                                            @csrf
                                            @method('patch')
                                            <div class="row">
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                       ...
                                                       <input type="text" name="title" class="form-control" placeholder="Введите название" value="{{ $catalog->title ?? '' }}">
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                       ...
                                                       <input type="text" name="seo_title" class="form-control" placeholder="Введите seo название" value="{{ $catalog->seo_title }}">
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                       ...
                                                       <textarea class="form-control" name="description" placeholder="Введите описание">{{ $catalog->description ?? '' }}</textarea>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="seo_description" placeholder="Введите seo описание">{{ $catalog->seo_description ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="meta_keywords" placeholder="Введите мета ключи">{{ $catalog->meta_keywords }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <img src="{{ asset($catalog->category_img) }}" alt="" style="150px">
