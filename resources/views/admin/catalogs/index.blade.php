                                        ...
                                        <p class="text-muted font-13 m-b-30">
                                            ...
                                            <ul class="nav navbar-right panel_toolbox">
                                                ...
                                                <li class="dropdown" style="padding-right: 15px;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="{{ route('admin.catalog.create') }}">Создать Каталог</a>
                                        ...
                                        @foreach($catalogs as $catalog)
                                            <tr>
                                                ...
                                                <td style="display: flex; justify-content: center;">
                                                    <a href="{{ route('admin.catalog.edit', $catalog->id) }}" class="btn btn-outline-primary">
                                                    ...
                                                    <form action="{{ route('admin.category.delete', $catalog->id) }}" method="post">
                                                        @csrf
                                                        @method('patch')
