            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li class="dropdown" style="padding-right: 15px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="{{ route('admin.catalog.create') }}">Create
                                        catalog</a>
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-sm-12">
                                <form action="{{ route('admin.updateCatalogs') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('post')
                                        ...
                                        <table id="datatable-checkbox"
                                            ...
                                            @foreach($catalogs as $catalog)
                                                <tr>
                                                    <td>
                                                        <label>
                                                            <input readonly value="{{ $catalog->id }}" name="id[]" class="updateSelected" style="background: none; border: none">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            <input type="text" value="{{ $catalog->title }}"
                                                                   name="title_{{ $catalog->id }}"
                                                                   class="updateSelected">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            <textarea name="description_{{ $catalog->id }}"
                                                                      class="updateSelected">{{ $catalog->description }}</textarea>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            <input type="text" value="{{ $catalog->seo_title }}"
                                                                   name="seo_title_{{ $catalog->id }}"
                                                                   class="updateSelected">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            <textarea name="seo_description_{{ $catalog->id }}"
                                                                      class="updateSelected">{{ $catalog->seo_description }}</textarea>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            <textarea name="meta_keywords_{{ $catalog->id }}"
                                                                      class="updateSelected">{{ $catalog->meta_keywords }}</textarea>
                                                        </label>
                                                    </td>
