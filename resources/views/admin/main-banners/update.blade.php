                                                ...
                                                <td>
                                                    ...
                                                    <label>
                                                        <select name="type" id="" class="select" title="Не выбрано">
                                                            ...
                                                            <option value="1330x400px" @if($banner->type == "1330x400px") selected @endif>Баннер на первом экране: десктоп
                                                                - 1330х400px
                                                            </option>
                                                            <option value="536x270px" @if($banner->type == "536x270px") selected @endif>Баннер на первом экране: мобильный
                                                                - 536х270px
                                                            </option>
                                                            <option value="410x450px"@if($banner->type == "410x450px") selected @endif>Рекламные баннеры на странице:
                                                                левый - 410х450px
                                                            </option>
                                                            <option value="840x450px"@if($banner->type == "840x450px") selected @endif>Рекламные баннеры на странице:
                                                                правый - 840х450px
                                                            </option>
                                                            <option value="536x290px"@if($banner->type == "536x290px") selected @endif>Рекламные баннеры на странице:
                                                                мобильный - 536х290px
                                                            </option>
                                                            <option value="238x420px"@if($banner->type == "238x420px") selected @endif>Рекламные блоки на главной
                                                                странице в категориях 1 вид: Десктоп вертикальный -
                                                                238х420px
                                                            </option>
                                                            <option value="536x220px"@if($banner->type == "536x220px") selected @endif>Рекламные блоки на главной
                                                                странице в категориях 1 вид: Мобильный горизонтальный -
                                                                536х220px
                                                            </option>
                                                            <option value="496x420px"@if($banner->type == "496x420px") selected @endif>Рекламные блоки на главной
