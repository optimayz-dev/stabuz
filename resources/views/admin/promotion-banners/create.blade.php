                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    @endif
                                    <form action="{{ route('admin.promotion-banner.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        @enderror
                                                        <label>
                                                            <input type="text" value="" name="title" class="updateSelected" placeholder="Заголовок">
                                                        </label>
                                                    </td>
