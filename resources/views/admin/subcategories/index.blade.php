                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <div class="nav-box">
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                            ...
                                            <li class="dropdown" style="padding-right: 15px;">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{ route('admin.subcategory.create') }}">Add subcategory</a>
                                    ...
                                    <form action="{{ route('admin.subcategory.handleBulkActions') }}" method="post">
                                        @method('patch')
                                        @csrf
                                        @if (session('success'))
...
{{--                                                    </td>--}}
                                                    ...
                                                    <td style="display: flex; justify-content: center;">
                                                        <a href="{{ route('admin.subcategory.edit', $subcategory->id) }}" class="btn btn-outline-primary">
