                                        ...
                                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $news->title ?? '' }}" name="title" class="updateSelected" placeholder="Название">
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <input type="text" value="{{ $news->seo_title ?? '' }}" name="seo_title" class="updateSelected" placeholder="Seo название">
                                                    </label>
                                                </td>
                                                <td>
                                                    @error('description')
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <textarea name="description" class="updateSelected" placeholder="Описание">{{ $news->description ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <textarea name="seo_description" class="updateSelected" placeholder="Seo Описание">{{ $news->seo_description ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label>
                                                        <textarea type="text" name="meta_keywords" placeholder="Мета ключи" class="updateSelected">{{ $news->meta_keywords ?? '' }}</textarea>
                                                    </label>
                                                </td>
                                                <td>
                                                    @error('image')
                                                    ...
                                                    @enderror
                                                    <label for="">
                                                        <img src="{{ asset($news->image ?? '') }}" alt="" style="width: 70px">
