                                        ...
                                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $faq->question ?? '' }}" name="question" class="updateSelected" placeholder="Вопрос">
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @enderror
                                                    <label>
                                                        <input type="text" value="{{ $faq->answer ?? '' }}" name="answer" class="updateSelected" placeholder="Ответ">
                                                    </label>
                                                </td>
                                            </tr>
                                            </tbody>
