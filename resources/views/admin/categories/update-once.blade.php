                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    @endif
                                    <div class="container">
                                        <form action="{{ route('admin.category.update', $category->id) }}" method="POST" class="categories" enctype="multipart/form-data">
                                            @csrf
                                            @method('patch')
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                       ...
                                                       <input type="text" name="seo_title" class="form-control" placeholder="Введите seo название" value="{{ $category->seo_title }}">
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="seo_description" placeholder="Введите seo описание">{{ $category->seo_description ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="meta_keywords" placeholder="Введите мета ключи">{{ $category->meta_keywords }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <img src="{{ asset($category->category_img) }}" alt="" style="150px">
