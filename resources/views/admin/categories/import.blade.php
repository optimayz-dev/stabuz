                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <div class="btn-wrapper" style="display: flex">
                                        <form action="{{ route('admin.category.import') }}" method="post" enctype="multipart/form-data" style="margin-right: 20px">
                                            @csrf
                                            <input type="file" name="file">
                                            <button type="submit" class="btn btn-success">import data</button>
                                        </form>
                                        <a class="btn btn-danger" href="{{ route('admin.category.export') }}">export all categories</a>
                                    </div>
                                </div>
                            </div>
                        </div>
