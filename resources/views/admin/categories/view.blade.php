                    ...
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li class="dropdown" style="padding-right: 15px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="{{ route('admin.category.createFromParent', $category->id) }}">Add category</a>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <form action="{{ route('admin.category.handleBulkActions') }}" method="post">
                                        ...
                                        <input type="hidden" value="{{ \Illuminate\Support\Facades\URL::previous().'/'. $category->id}}" name="url">
                                            ...
                                            @foreach($category->children as $children)
                                                <tr>
                                                    ...
                                                    <td style="display: flex; justify-content: center;">
                                                        <a href="{{ route('admin.category.editFromParent', $children->id) }}" class="btn btn-outline-primary">
                                                        ...
                                                        <form action="{{ route('admin.category.delete', $children->id) }}" method="post">
                                                            @csrf
                                                            @method('patch')
